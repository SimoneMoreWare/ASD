...
struct queue {
    Item *b;          /* Buffer (vettore di Item) */
    int testa, coda;  /* indici di testa (prima cella occupata) e coda (ultima cella occupata) */
    int n_el;         /* numero di elementi attualmente memorizzati */
    int size;         /* dimensione del buffer [0..size-1] */
};
