...
int main(void) {
  ...
  cont = 1;
  while(cont) {
    printf("\nOperations on unweighted undirected graphs\n");
    printf("===============\n");
      ...
      switch(i) {
            ...
            case 4:     printf("File (0) or Screen (1)? ");
                        ...
                        if (sel==0) {
                          ...
                          GRAPHstore(G,stdout);
                        break;
            case 5:     printf("Insert first node = ");
                        scanf("%s", label);
                        id1 = GRAPHgetIndex(G, label);
                        printf("Insert second node = ");
                        scanf("%s", label);
                        ...
                        GRAPHpath(G, id1, id2);
                        break;
            case 6:     printf("Insert first node = ");
                        scanf("%s", label);
                        id1 = GRAPHgetIndex(G, label);
                        printf("Insert second node = ");
                        scanf("%s", label);
                        id2 = GRAPHgetIndex(G, label);
                        GRAPHpathH(G, id1, id2);
                        break;
            case 7:     printf("Insert start node = ");
                        scanf("%s", label);
                        id1 = GRAPHgetIndex(G, label);
                        GRAPHbfs(G, id1);
                        break;
