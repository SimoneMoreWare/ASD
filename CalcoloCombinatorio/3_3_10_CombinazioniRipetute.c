...
int main(void){
  ...
  if(scanf("%d",&i)<=0) {
    ...
    switch(i) {
      case 1: printf("Inserisci il numero di passi n: ");
              scanf("%d", &n);
              valor = malloc(n * sizeof(Livello));
              for(i = 0; i < n; i++) {
              ...
              printf("Principio di moltiplicazione - soluzioni: \n");
              total = princ_molt(0, valor, sol, n, 0);
